  ...
  return (
    <div className='w-full py-[10rem] px-4 bg-white text-black'>
      <div className='text-center text-4xl pb-[2rem]'>
        <h1 className='font-Glock text-5xl text-[#e57626]'>Meet The Developers</h1>
      </div>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-4 gap-6 py-10'>
        <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
          ...
          <div className='flex py-3 justify-center'>
            ...
            <Link to={"https://www.linkedin.com/in/channelharris/"}><svg class="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin">
        ...
        <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
          ...
          <div className='flex py-3 justify-center'>
            {/* <AiFillLinkedin size={40}/> */}
            <Link to={"https://www.linkedin.com/in/chikodimerenu/"}><svg class="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                <rect x="2" y="9" width="4" height="12"></rect>
                <circle cx="4" cy="4" r="2"></circle>
            </svg></Link>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
          ...
          <div className='flex py-3 justify-center'>
            {/* <AiFillLinkedin size={40}/> */}
            <Link to={"https://www.linkedin.com/in/joshuaascolillo/"}><svg class="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                <rect x="2" y="9" width="4" height="12"></rect>
                <circle cx="4" cy="4" r="2"></circle>
            </svg></Link>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
          ...
          <div className='flex py-3 justify-center'>
            {/* <AiFillLinkedin size={40}/> */}
            <Link to={"https://www.linkedin.com/in/erin-keys-978798257/"}><svg class="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                <rect x="2" y="9" width="4" height="12"></rect>
                <circle cx="4" cy="4" r="2"></circle>
            </svg></Link>
