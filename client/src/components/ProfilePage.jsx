    ...
    <div className='flex-row-reverse w-screen h-screen'>
        <div className='w-[750px] h-screen bg-white mx-auto my-auto rounded-2xl overflow-hidden'>
            ...
            <div className='flex-col'>
                <h2 className='text-center text-[18px] font-main font-bold mt-[12px]'>Chikodi Merenu <span className='font-light text-[#6B7082] ml-2'>25</span></h2>
                <h2 className='text-center font-main text-[14px] mt-[12px]'>USA</h2>
