  ...
  return (
    <div className='w-full bg-grey py-16 px-4 text-black'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        <img className='q-[500px] mx-auto my-4' src={Logo} /> 
        <div className='flex flex-col justify-center'>
          <p className='text-[#e57626] font-bold'>THE ULTIMATE SOCIAL MEDIA APP</p>
          <h1 className='md:text-4xl sm:text-3xl text-3xl text-2xl font-bold py-2'>Connect with Like-Minded Individuals Across the World </h1>
          ...
          <button className='bg-[#e57626] w-[200px] rounded-md my-6 mx-auto md:mx-0 py-3 text-black'>Register Now!</button>
        </div>
      </div>
    </div>
  )
