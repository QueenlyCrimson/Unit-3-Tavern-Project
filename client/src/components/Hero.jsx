  ...
  return (
    <div>
      ...
      <div className='flex justify-center'>
        ...
        <Typed className='text-[#d98345] md:text-3xl sm:text-2xl text-xl font-bold md:pl-4 pl-2'
        strings={[
          'Foodie',
          'Gamer',
          'Fitness Enthusiast', 
      ...
      <button className='bg-[#d98345] w-[200px] rounded-md my-6 mx-auto py-3 text-black' >Sign Up!</button>
      </div>
    </div>
  )
}
